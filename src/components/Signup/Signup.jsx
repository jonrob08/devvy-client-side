  ...
  return (
    <Box className="Signup">
      <Box className="content" onClick={(e) => e.stopPropagation()}>
        ...
        >
          <Box>
            <Typography variant="h5" color="black">Sign up for Devvy and Get To Work!</Typography>
            <Typography variant="subtitle2" color="black">It's quick and easy.</Typography>
          </Box>
        ...
        <form onSubmit={HandleSubmit}>
          <FormControl>
            <Box className="nameFields" display="flex" justifyContent="center">
              ...
              />
              <TextField
                error={Err.full_name ? true : false}
                helperText={Err.full_name && Err.full_name}
                variant="outlined"
                size="small"
          ...
          <Typography
            ...
            variant="caption"
          >
            Date of birth <HelpIcon className="helpIcon" />
          </Typography>
          ...
          <Box className="GenderContainer">
            <Typography
              ...
              variant="caption"
            >
              Gender <HelpIcon className="helpIcon" />
            </Typography>
          ...
          >
            {" "}
            {waiting ? <CircularProgress /> : "Sign Up  "}{" "}
          </Button>
        </form>
      </Box>
    </Box>

...
import { addComment, DeletePost, Like } from '../../API/Post';
import { AppContext } from '../../ContextApi/AppContext';
import { HandleErr } from '../../Utils/Utils';

const Post = ({data , OpenCreatePost , setPostData}) => {
    const {dispatchPost , UserGState} = useContext(AppContext);
    ...
    const submitComment = async (e) => {
        ...
        await addComment(comment).then(res => {
            dispatchPost({type:"ADD_COMMENT" , payload:res.data});
    ...
    const RemovePost = async () => {
        await DeletePost(data._id).then(res => {
            dispatchPost({type:"DELETE_POST" , payload:data._id})
